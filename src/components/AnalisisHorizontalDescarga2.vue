          ...
          <div class="row-table">
            ...
            <div class="row">
              <div class="item text-header">
                <span class="text-center"> {{ estado1.anio }}</span>
              </div>
              <div class="item text-header">
              ...
              <div class="item text-header">
                <span class="text-center ml-2">Abosuta</span>
              </div>
            ...
            <div class="row mt-4">
              ...
              <div  v-show="isVisible" class="item mt-3">
                <span
                  v-show="
            ...
            <div class="row">
              ...
              <div  v-show="isVisible" class="item mt-2">
                <span
                  v-show="
            ...
            <div class="row">
              <div class="item mt-2">
                <span class="text-center">
                  {{
                    estado1.ingreso_de_operaciones.intereses_inversiones
                  }}</span
                >
              </div>
              <div class="item mt-2">
                <span class="text-center">
                  {{
                    estado2.ingreso_de_operaciones.intereses_inversiones
                  }}</span
                >
              </div>
              <div class="item mt-2">
                <span class="text-center">
                  {{
                    var_rel_2.ingreso_de_operaciones.intereses_inversiones
                  }}</span
                >
              </div>
              <div class="item mt-2">
            ...
            <div class="row mt-4">
              ...
              <div  v-show="isVisible" class="item mt-4 ">
                <span
